...
Error::ERROR errors[ERROR_MAX_ENTRY] = {
	...
	ERROR_ENTRY(606, "[SA]: Ошибка в цикле"),
	...
	ERROR_ENTRY(701, "[SemA]: Несоответствие типов параметров функции"),
	ERROR_ENTRY(702, "[SemA]: Превышено стандартное число параметров функции"),//'s'
	ERROR_ENTRY(703, "[SemA]: Несоответсвие присваимаего типа данных"),
	ERROR_ENTRY(704, "[SemA]: Несоответствие типа функции и возвращаемого значения"),// 's'
	ERROR_ENTRY(705, "[SemA]: Main Должен возвращать числовое значение"),
	ERROR_ENTRY(706, "[SemA]: Неверное количество параметров функции"),
